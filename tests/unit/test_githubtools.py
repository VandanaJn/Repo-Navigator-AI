...
def test_safe_get_contents_success():
    ...
    result = src.githubtools.safe_get_contents(repo, "path/file.txt", "main")
...
def test_safe_get_contents_404_returns_none():
    ...
    result = src.githubtools.safe_get_contents(repo, "missing.txt", "main")
...
def test_safe_get_contents_rate_limit_retries_and_succeeds():
    ...
    result = src.githubtools.safe_get_contents(repo, "foo", "main")
...
def test_safe_get_contents_rate_limit_exhausted():
    ...
    result = src.githubtools.safe_get_contents(repo, "foo", "main", max_retries=2)
...
def test_get_repo_structure_lists_files(mock_client):
    ...
    result = src.githubtools.get_repo_structure("me", "testrepo")
...
def test_get_repo_structure_truncated(mock_client):
    ...
    result = src.githubtools.get_repo_structure("me", "repo", max_depth=1)
...
def test_read_file_content_success(mock_client):
    ...
    result = src.githubtools.read_file_content("me", "repo", "README.md")
...
def test_read_file_content_404(mock_client):
    ...
    result = src.githubtools.read_file_content("me", "repo", "missing.md")
    assert result is None
...
def test_read_file_content_rate_limit_retry(mock_client):
    ...
    result = src.githubtools.read_file_content("me", "repo", "file.txt")
    assert result == "ok"
